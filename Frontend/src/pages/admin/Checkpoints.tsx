...
const AdminCheckpoints: React.FC = () => {
  ...
  if (isLoading) return <div className="animate-pulse space-y-4 pt-8 max-w-4xl mx-auto">
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      <div className="flex justify-between items-center">
        <Link to="/admin/projects" className="flex items-center text-sm text-text-secondary hover:text-primary-blue">
      ...
      <div>
        <h1 className="text-2xl font-bold text-text-primary">Admin Milestone Management</h1>
        <p className="text-text-muted">Directly manage delivery points for project <span className="text-primary-blue font-semibold">#{projectId}</span></p>
      </div>
      ...
      <div className="space-y-4">
        ...
        {checkpoints.length === 0 && !isAdding && (
          <div className="text-center py-16 bg-bg-soft rounded-2xl border-2 border-dashed border-gray-100">
            ...
            <p className="text-text-muted mt-1">Start by adding the first project deliverable for this project.</p>
